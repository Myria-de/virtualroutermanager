...
namespace VirtualRouterClient
{
    ...
    public partial class WindowMain : Window
    {
        ...
        {
            Process.Start("http://www.myria.de/computer/1214-virtual-router-manager-1-0-unter-windows-88-1");
        }
        ...
        void myApp_VirtualRouterServiceDisconnected(object sender, EventArgs e)
        {
            ...
            //this.trayIcon.Text = "Virtual Router (Disabled)";
            lblStatus.Content = VirtualRouterClient.Properties.Resources.NoService;
            this.trayIcon.Text = VirtualRouterClient.Properties.Resources.VDisabled;
            UpdateDisplay();
        }
        ...
        void myApp_VirtualRouterServiceConnected(object sender, EventArgs e)
        {
            ...
            lblStatus.Content = VirtualRouterClient.Properties.Resources.NowManaged;
            UpdateDisplay();
        }
        ...
        private void UpdateDisplay()
        {
            ...
            if (myApp.IsVirtualRouterServiceConnected)
            {
                ...
                groupBoxPeersConnected.Header = VirtualRouterClient.Properties.Resources.Peers +  " (" + peers.Count().ToString() + "):";
            ...
            else
            {
                ...
                groupBoxPeersConnected.Header = VirtualRouterClient.Properties.Resources.Peers2;
            }
        }
                ...
                else
                {
                    if (this.ValidateFields())
                    {
                        ...
                        else
                        {
                            ...
                            lblStatus.Content = VirtualRouterClient.Properties.Resources.Started;
                        }
        ...
        private bool ValidateFields()
        {
            ...
            if (txtSSID.Text.Length <= 0)
            {
                ...
                errorMessage += VirtualRouterClient.Properties.Resources.SSIDReq + Environment.NewLine;
            }

            if (txtSSID.Text.Length > 32)
            {
                //errorMessage += "Network Name (SSID) can not be longer than 32 characters." + Environment.NewLine;
                errorMessage += VirtualRouterClient.Properties.Resources.SSIDLen + Environment.NewLine;
            }

            if (txtPassword.Text.Length < 8)
            {
                //errorMessage += "Password must be at least 8 characters." + Environment.NewLine;
                errorMessage += VirtualRouterClient.Properties.Resources.PWDMin + Environment.NewLine;
            }

            if (txtPassword.Text.Length > 64)
            {
                //errorMessage += "Password can not be longer than 64 characters." + Environment.NewLine;
                errorMessage += VirtualRouterClient.Properties.Resources.PWDLen + Environment.NewLine;
            }
            ...
            if (myApp.IsVirtualRouterServiceConnected)
            {
                ...
                try
                {
                    ...
                    if (myApp.VirtualRouter.IsStarted())
                    {
                        ...
                        btnToggleHostedNetwork.Content = VirtualRouterClient.Properties.Resources.Button_Stop;
                        //this.trayIcon.Text = "Virtual Router (Running)";
                        this.trayIcon.Text = VirtualRouterClient.Properties.Resources.VRunning;
                    ...
                    else
                    {
                        ...
                        //VirtualRouter.Properties.Resources.Button1;
                        //btnToggleHostedNetwork.Content = "Start Virtual Router";
                        btnToggleHostedNetwork.Content = VirtualRouterClient.Properties.Resources.Button1;
                        //this.trayIcon.Text = "Virtual Router (Stopped)";
                        this.trayIcon.Text = VirtualRouterClient.Properties.Resources.VStopped;
                        this.trayIcon.Icon = new System.Drawing.Icon(
